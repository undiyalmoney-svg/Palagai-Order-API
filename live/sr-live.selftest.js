...
assert.strictEqual(n.giveUpBar, 0, '15.9: stall give-up off (Paper===Live)');
assert.strictEqual(n.giveUpMinPts, 0);
...
assert.strictEqual(n.structureExit, false, '15.9 does not STRUCTURE-exit; TIME / rupee stop');
...
assert.strictEqual(SPEC.banknifty.opts.giveUpBar, 0);
