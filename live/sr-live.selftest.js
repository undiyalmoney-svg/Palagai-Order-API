...
assert.strictEqual(n.lockArmPts, 0, 'index lock scratches CE/PE; hold to TIME 6');
assert.strictEqual(n.giveUpBar, 0, 'give-up scratches CE/PE; hold to TIME 6');
assert.strictEqual(n.targetByScore[1], 0, 'no +20 index TARGET on option books');
assert.strictEqual(n.timeStopBars, 6, '15 Sep Kite hold was ~6×5m bars');
