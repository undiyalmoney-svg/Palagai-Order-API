  ...
  if (body.liveMoney === true || body.liveMoney === 'true') {
    try {
      ...
      res.json({
        ...
        note:
          'Crude Bot live trades MCX CRUDEOILM futures (MIS). Same retest playbook as Nifty/Bank. It does not touch Nifty or Bank. Stop live on this tab stops only Crude Bot.',
      });
    } catch (err) {
